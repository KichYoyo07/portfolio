    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            try {
                ...
                const { data: projects, error } = await supabase.from('projects').select('id, featured');
                    ...
                    <CardContent>
                        <ul className='space-y-4'>
                            <li className='flex items-start'>
                                <span className='inline-flex items-center justify-center h-6 w-6 rounded-full bg-gray-100 text-gray-800 text-sm mr-3'>
                                    1
                                </span>
                                <div>
