    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
                            Hola, soy{" "}
                            <span className="bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Inancy Karina</span>
                        </h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6">
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Soy un desarrollador full stack con más de 3 años de experiencia creando aplicaciones
                                web y móviles. Me
                                especializo en tecnologías modernas como React, Next.js y Node.js.
                            </p>
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Mi pasión es transformar ideas complejas en soluciones digitales elegantes y
                                funcionales. Siempre busco
                                aprender nuevas tecnologías y mejorar mis habilidades.
                            </p>
                            <div className="flex flex-wrap gap-3">
                                {["JavaScript", "TypeScript", "React", "Tailwind CSS", "Next.js", "Node.js", "MCP", "Python", "SQl", "NoSql"].map((tech) => (
                                    <Badge
                                        key={tech}
                                        variant="secondary"
                                        className="px-3 py-1 bg-white text-gray-700 border border-gray-200"
                                    >
                                        {tech}
                                    </Badge>
                                ))}
                        ...
                        <div className="relative">
                            <div
                                className="w-80 h-80 mx-auto bg-gradient-to-br from-gray-200 to-gray-300 rounded-2xl overflow-hidden">
                                <img src="/17kich.jpeg?height=320&width=320" alt="Profile"
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    {loading ? (
                        <div className="text-center py-12">
                            <div
                                className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-gray-900 border-r-transparent"></div>
                                    ...
                                    <CardContent className="p-6 flex flex-1 flex-col justify-between">
                                        ...
                                        : <div className="flex justify-center">
                                            <Button 
                                                variant="outline"
                                                size="sm"
                                                className="text-xs">Por motivos de confidencialidad 
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {skills.map((skill, index) => (
                            <Card key={index}
                                className="p-6 hover:shadow-lg transition-shadow duration-300 border-0 shadow-md">
                ...
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
                        ...
                        <Dialog.Portal>
                            ...
                            <Dialog.Content
                                className="fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] w-full max-w-md bg-white rounded-lg p-6 shadow-xl">
                                <Dialog.Title className="text-2xl font-bold text-gray-900 mb-4">
                                    Enviar Mensaje
                                </Dialog.Title>
                                <Dialog.Description className="text-sm text-gray-500 mb-4">
                                    Complete el formulario para enviarme un mensaje. Me pondré en contacto con usted lo
                                    antes posible.
                                </Dialog.Description>
            ...
            <footer className="py-8 px-6 border-t border-gray-100">
                <div className="max-w-4xl mx-auto text-center">
                    <p className="text-gray-600">© 2024 Kich Portfolio. Diseñado y desarrollado con V0, cursor, MCP,
                        IA</p>
                </div>
            </footer>
